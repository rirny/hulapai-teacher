...
class User_GroupController extends Yaf_Controller_Base_Abstract {
	...
	public function indexAction(){
		...
		$groups = $_AdminUserGroup->getList($page,20,array('type'=>'school','school'=>$this->school));
	...
	public function addAction(){
		if($this->_POST['info']){
			...
			$this->_POST['info']['type'] = 'school';
			$this->_POST['info']['school'] = $this->school;
			$_AdminUserGroup = new Admin_User_GroupModel();
	...
	public function deleteAction(){
		...
		show_message('删除成功！',url('school','user_group'));
	}
	/**
	 * 修改权限
	 */

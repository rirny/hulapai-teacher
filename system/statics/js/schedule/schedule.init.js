scheduler.customer = function(){
	...
	if(window.hulapai.module){
		if(window.hulapai.module == "school"){
	...
	//};
	if(!window.hulapai.start_date || !window.hulapai.end_date){
		...
		start_date = window.hulapai.start_date;
		end_date = window.hulapai.end_date;
		scheduler.init('scheduler_here', new Date(Date.parse(start_date.replace(/-/g, "/"))),"week");
	}
	window.hulapai.start_date = start_date;
	window.hulapai.end_date = end_date;
	scheduler.load(window.hulapai.urlEvent+"&start_date="+start_date+"&end_date="+end_date);
	...
	scheduler.attachEvent("onViewChange",function(type, native_event_object,url){
		...
		window.hulapai.start_date = start_date;
		window.hulapai.end_date = end_date;
		url = url || window.hulapai.urlEvent+"&start_date="+start_date+"&end_date="+end_date;
		scheduler.load(url);
	});
};
